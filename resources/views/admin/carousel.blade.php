...
<div class="layui-body" id="LAY_app_body">
  ...
  </div><div class="layui-fluid" id="LAY-demo-carousel">
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">常规轮播</div>
          <div class="layui-card-body">
            <div class="layui-carousel" id="test-carousel-normal" lay-filter="test-carousel-normal" lay-anim="" lay-indicator="inside" lay-arrow="always" style="width: 600px; height: 280px;">
              <div carousel-item="">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            ...
            <div class="layui-form">
              ...
              <div class="layui-form-item">
                <div class="layui-inline">
                  ...
                  <div class="layui-input-block">
                    <input type="checkbox" name="switch" lay-skin="switch" checked="" lay-text="ON|OFF" lay-filter="test-carousel-autoplay"><div class="layui-unselect layui-form-switch layui-form-onswitch" lay-skin="_switch"><em>ON</em><i></i></div>
                  </div>
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-carousel" id="test-carousel-demo" lay-filter="test-carousel-demo" lay-anim="" lay-indicator="inside" lay-arrow="hover" style="width: 600px; height: 280px;">
              <div carousel-item="">
                <div class="">条目1</div>
                <div class="">条目2</div>
                <div class="layui-this">条目3</div>
                <div class="">条目4</div>
                <div class="">条目5</div>
              </div>
            <div class="layui-carousel-ind"><ul><li class=""></li><li class=""></li><li class="layui-this"></li><li class=""></li><li class=""></li></ul></div><button class="layui-icon layui-carousel-arrow" lay-type="sub"></button><button class="layui-icon layui-carousel-arrow" lay-type="add"></button></div>
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <div class="layui-carousel" id="test-carousel-img" lay-anim="" lay-indicator="inside" lay-arrow="hover" style="width: 778px; height: 440px;">
              <div carousel-item="">
                ...
                <div class="layui-this layui-carousel-left"><img src="//res.layui.com/images/layui/demo/4.png"></div>
                <div class="layui-carousel-next layui-carousel-left"><img src="//res.layui.com/images/layui/demo/5.png"></div>
                <div class=""><img src="//res.layui.com/images/layui/demo/6.png"></div>
                <div class=""><img src="//res.layui.com/images/layui/demo/7.png"></div>
              </div>
            <div class="layui-carousel-ind"><ul><li class=""></li><li class=""></li><li class=""></li><li class=""></li><li class="layui-this"></li><li class=""></li><li class=""></li></ul></div><button class="layui-icon layui-carousel-arrow" lay-type="sub"></button><button class="layui-icon layui-carousel-arrow" lay-type="add"></button></div>
          </div>
        </div>
      </div>
    </div>
