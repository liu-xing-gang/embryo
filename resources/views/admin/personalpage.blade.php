          ...
          <div class="layui-card-body">
            <div class="layadmin-homepage-pad-ver">
              <script type="text/html" template="">
                <img class="layadmin-homepage-pad-img" src="{{asset('images/portrait.png')}}" width="96" height="96">
              </script> <img class="layadmin-homepage-pad-img" src="{{asset('images/portrait.png')}}" width="96" height="96">
            </div>
            ...
            <div class="grid-demo">
              <div class="panel-body layadmin-homepage-shadow">
                ...
                <div class="media-body">
                  ...
                  <script type="text/html" template="">
                    <img class="h-img" src="{{asset('images/huge.jpg')}}">
                  </script> <img class="h-img" src="{{asset('images/huge.jpg')}}">
                    ...
                    <div class="media-left">
                      <ul class="list-inline">
                        <li>
                          <a href="javascript:;">
                            <script type="text/html" template="">
                              <img class="img-xs" src="{{asset('images/portrait.png')}}">
                            </script> <img class="img-xs" src="{{asset('images/portrait.png')}}">
                          </a>
                        </li>
                        <li>
                          <a href="javascript:;">
                ...
                <div class="layui-card-body">
                  <div class="layui-row layui-col-space15">
                    <div class="layui-col-md4">
                      ...
                      </script> <img src="{{asset('images/portrait.png')}}">
                    </div>
                    <div class="layui-col-md4">
                      <script type="text/html" template="">
                        <img src="{{asset('images/portrait.png')}}">
